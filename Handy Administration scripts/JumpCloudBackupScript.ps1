...
$BackupLocation = "D:\Backup\JumpCloud Backup" # Enter full path to desired backup folder for backup CSV files. Example path on Mac "/Users/Buster/Backup/JCBackup"

$JumpCloudAPIKey = "ca8a6ab2bfc8ab0d7c56af7cd69443bb536b6bb1" # The JumpCloud API key can be found in the admin console by selecting the drop down icon next to admin email in top right and selecting "API Settings"
